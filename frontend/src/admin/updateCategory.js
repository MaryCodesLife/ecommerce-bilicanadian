...
const UpdateCategory = ({ match }) => {
    ...
    const updateCategoryForm = () => (
        <div className="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
            <form className="mb-5" onSubmit={submitCategoryForm}>
                <span className="login100-form-title p-b-32 m-b-7">Update your product!</span>
    ...
    return (
        <Layout
            title={`Hi, ${user.name}! Are you ready to update your product?`}
            description={`This is Update Product Action!`}
